/*
 * (C) Copyright 2017 example.gerardogarcia.mylibrary (https://example.gerardogarcia.mylibrary.com/) and others.
 *
 ...
 *
 * Contributors:
 *     Bohdan Bezpartochnyi <bohdan@example.gerardogarcia.mylibrary.com>
 */
